        ...
        <body className="leading-normal tracking-normal text-white gradient">
            ...
            <nav id="header" className="fixed w-full z-30 top-0 text-white bg-white shadow">
              ...
              <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                ...
                <div className="pl-4 flex items-center">
                  <a className="toggleColour no-underline hover:no-underline font-bold text-2xl 
                  lg:text-4xl text-gray-600"  href="#"> 
                    ...
                    </svg> photobo<a className="h-8 fill-current inline text-purple-600">AR</a>d
                  </a>
                </div>
                ...
                <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                  <ul className="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    <li className="mr-3">
                      <a className="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Demo</a>
                    </li>
                  </ul>
            ...
            <div className="pt-24">
              ...
              <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                  ...
                  <h1 className="my-4 text-5xl font-bold leading-tight">Storyboard Your Film in AR</h1>
                  ...
                  <form action={data.site.siteMetadata.github}>
                    <button className="w-6/12 p-5"><img src={ios} /></button>
                    <button className="w-6/12 p-5"><img src={ios} /></button>
                  </form>
                ...
                <div className="w-full md:w-3/5 py-6 text-center">
                  <img className="w-full place-self-end md:w-4/5 z-50" src={heroImg} />
                </div>
            ...
            <section className="bg-white border-b py-8">
              <div className="container mx-auto flex flex-wrap pt-4 pb-12">
                <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">Draft Your Scenes</h3>
                    <p>Take control of your projects by breaking them down into films and scenes</p>
                  <img className=" place-self-end md:w-4/5 z-50" src={vector} />
                </div>
                {/* 
                 */}
                <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">Choose From 170 Unique Models and Poses</h3>
                    <p></p>
                  <img className="w-full place-self-end md:w-4/5 z-50" src={vector} />
                </div>
                
                {/* 
                 */}
                <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">Snapshot</h3>
                  <img className="w-full place-self-end md:w-4/5 z-50" src={vector} />
                </div>
                {/* 
                 */}
            ...
            <section className="bg-white border-b py-8">
              ...
              <div className="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                {/* <h3 className="w-full my-2 text-3xl font-bold leading-tight text-center text-gray-800"></h3> */}
            ...
            <section className="container mx-auto text-center py-6 mb-12">
              ...
              <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-white">Download for IOS or Android</h1>
              <div className="w-full mb-4">	
              ...
              <div className="container mx-auto  px-8">
                  ...
                  <div className="flex-1 mb-6">
                    ...
                    <a className="text-gray-500 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"  href="#"> 
                      <svg className="h-8 fill-current inline text-purple-600" >
                      {/* <rect fill="#2a2a31" x="16.539" y="425.626" width="479.767" height="50.502" transform="matrix(1,0,0,1,0,0)" fill="rgb(0,0,0)" /> */}
                      {/* <path className="plane-take-off" d=" M 510.7 189.151 C 505.271 168.95 484.565 156.956 464.365 162.385 L 330.156 198.367 L 155.924 35.878 L 107.19 49.008 L 211.729 230.183 L 86.232 263.767 L 36.614 224.754 L 0 234.603 L 45.957 314.27 L 65.274 347.727 L 105.802 336.869 L 240.011 300.886 L 349.726 271.469 L 483.935 235.486 C 504.134 230.057 516.129 209.352 510.7 189.151 Z "/> */}
                      </svg> photoboARd
                    </a>
